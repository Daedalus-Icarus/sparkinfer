...
void launch_quantize_i8(const void* in_bf16, int8_t* out, float* scale, int n,
                        cudaStream_t stream = nullptr);

// Inverse: out = in * scale.
void launch_dequantize_i8(const int8_t* in, const float* scale, void* out_bf16, int n,
                          cudaStream_t stream = nullptr);
...
void launch_dequant_int4_block(const uint8_t* packed, const void* scales_bf16,
